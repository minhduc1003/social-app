...
const DetaiInfo = () => {
  ...
  const { isOpenChangeDetailProfile } = appSelecter((state) => state.modal);
  return (
    <>
      <div className={style.datailInfo}>
        <h2>INTRO</h2>
        ...
        <p className={style.follow}>
          <span>52,844</span>Followers
        </p>
        <p className={style.follow}>
          <span>52,844</span>Following
        </p>
        <div
          className={style.editBtn}
          onClick={() => {
            dispatch(openModal(true));
            dispatch(openChangeDetailProfile(true));
          }}
        >
          Edit Details
        </div>
      </div>
      {isOpenChangeDetailProfile && <ChangeDetailInfo></ChangeDetailInfo>}
    </>
  );
};
